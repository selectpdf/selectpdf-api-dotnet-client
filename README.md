...
Download [selectpdf-api-dotnet-client-1.0.0.zip](https://github.com/selectpdf/selectpdf-api-dotnet-client/releases/download/1.0.0/selectpdf-api-dotnet-client-1.0.0.zip), unzip it and add a reference to SelectPdf.Api.dll to your project.
