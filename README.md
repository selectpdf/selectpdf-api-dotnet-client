...
Download [selectpdf-api-dotnet-client-1.3.1.zip](https://github.com/selectpdf/selectpdf-api-dotnet-client/releases/download/1.3.1/selectpdf-api-dotnet-client-1.3.1.zip), unzip it and add a reference to SelectPdf.Api.dll to your project.
...
```
Install-Package SelectPdf.Api -Version 1.3.1
```
