...
Download [selectpdf-api-dotnet-client-1.1.4.zip](https://github.com/selectpdf/selectpdf-api-dotnet-client/releases/download/1.1.4/selectpdf-api-dotnet-client-1.1.4.zip), unzip it and add a reference to SelectPdf.Api.dll to your project.
...
```
Install-Package SelectPdf.Api -Version 1.1.4
```
